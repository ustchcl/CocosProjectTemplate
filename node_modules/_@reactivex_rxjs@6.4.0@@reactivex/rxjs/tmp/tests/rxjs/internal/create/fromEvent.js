...
function fromEvent(target, eventName, options) {
    return new Observable_1.Observable(function (subscriber) {
        ...
        setupSubscription(target, eventName, handler, subscription, subscriber, options);
        return subscription;
    });
}
exports.fromEvent = fromEvent;
function setupSubscription(sourceObj, eventName, handler, subscription, subscriber, options) {
    var unsubscribe;
